...
import org.eclipse.kura.net.admin.modem.hspa.HspaModemFactory;
...
public class SupportedUsbModemsFactoryInfo {
	...
	public enum UsbModemFactoryInfo {
		...
		Huawei_USB		 (SupportedUsbModemInfo.Huawei_USB, HspaModemFactory.class, HspaModemConfigGenerator.class);
