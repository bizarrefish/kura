...
#set up Kura init
cp ${INSTALL_DIR}/kura/install/kura.init.olinuxino /etc/init.d/kura
...
cp ${INSTALL_DIR}/kura/install/network.interfaces.olinuxino /etc/network/interfaces
cp ${INSTALL_DIR}/kura/install/network.interfaces.olinuxino ${INSTALL_DIR}/kura/.data/interfaces

#set up network helper scripts
cp ${INSTALL_DIR}/kura/install/ifup-local.olinuxino /etc/network/if-up.d/ifup-local
...
if [ -d "/etc/monit/conf.d" ] ; then
    cp ${INSTALL_DIR}/kura/install/monitrc.olinuxino /etc/monit/conf.d/
fi
